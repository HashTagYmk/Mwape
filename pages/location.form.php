...
<div class="container p-3">
    <div class="row p-5">
        <div class="col-md-6 mx-auto shadow-sm p-3 mb-5 bg-body rounded">
            ...
            <h2 class="text-center">Add a Location</h2>
            <p class="text-center">Please fill this form to add a new location.</p>
            <form action="../scripts/create.location.process.php" method="post" enctype="multipart/form-data" class="row g-3">
