...
if(isset($_GET['location'])) {
    $location = get_location($_GET['location'], $db_connection);
}
...
<div class="container p-3">
    <div class="row p-5">
        <div class="col-md-6 mx-auto shadow-sm p-3 mb-5 bg-body rounded">
            ...
            <p class="text-center">Complete the form to book for <?php echo $location['name']; ?>.</p>
            <form action="../scripts/book.location.process.php" method="post" class="row g-3">
                <input type="text" value="<?php echo $location['id'];?>" name="location_id" id="location_id" class="visually-hidden">
