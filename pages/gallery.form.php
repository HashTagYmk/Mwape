...
<div class="container p-3">
    <div class="row p-5">
        <div class="col-md-6 mx-auto shadow-sm p-3 mb-5 bg-body rounded">
            ...
            <h2 class="text-center">Add to Gallery</h2>
            <p class="text-center">Please fill this form to an image to gallery.</p>
            <form action="../scripts/add.to.gallery.process.php" method="post" enctype="multipart/form-data" class="row g-3">
